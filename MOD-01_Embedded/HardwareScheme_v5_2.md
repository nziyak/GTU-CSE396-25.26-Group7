...
| PB12  | HC-SR04 #0 ECHO (Ön)     | Mesafe        | GPIO In (FT)  |
| PB13  | HC-SR04 #1 ECHO (Arka)   | Mesafe        | GPIO In (FT)  |
| PB14  | HC-SR04 #3 ECHO (Sağ)    | Mesafe        | GPIO In (FT)  |
| PB15  | HC-SR04 #2 ECHO (Sol)    | Mesafe        | GPIO In (FT)  |
| PC13  | ❌ ARIZALI — KULLANILMIYOR | —           | —             |
| PC14  | PWR_DECOY_EN             | Güç Yönetimi  | GPIO Out      |
| PC15  | PWR_PI_STATUS            | Güç Yönetimi  | GPIO In       |
...
## 11.5. Güç Yönetimi (Power Management)

| Sinyal | STM32 Pin | Notlar                                |
|--------|-----------|---------------------------------------|
| DECOY_EN | PC14    | 12V MOSFET gate (GPIO Out)            |
| PI_STATUS| PC15    | Pi 5V rail monitor (GPIO In)          |

Güç yönetimi pinleri PA5/PA6 üzerinden çalışıyordu ancak HC-SR04 sensörleri sebebiyle PC14/PC15 (RTC pinleri/Yedek pinler) üzerine taşındı.
